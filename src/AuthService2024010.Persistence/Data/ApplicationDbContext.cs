...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    private void UpdateTimestamps()
    {
        ...
        foreach( var entry in entries)
        {
            if(entry.Entity is User user)
            {
                ...
                else if(entry.Entity is UserRole userRoleAdded)
                {
                    if(entry.State == EntityState.Added)
                    {
                        userRoleAdded.CreatedAt = DateTime.UtcNow;
                    }
                    userRoleAdded.UpdatedAt = DateTime.UtcNow;
                }
    ...
    private static string ToSnakeCase(string input)
    {
        ...
        // la c es para indicar que es una cadena de caracteres
        //la i indica la posicion del caracter actual
