...
using AuthService2024010.Application.Exceptions;
using AuthService2024010.Application.Extensions;
using AuthService2024010.Application.Validators;
...
using AuthService2024010.Domain.Enums;
    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<RegisterResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        var user = new User
        {
            ...
            UserEmail = new UserEmail
            {
                ...
                UserId = userId,
                EmailVerified = false,
                EmailVerificactionToken = emailVerificationToken,
        ...
        return new RegisterResponseDto
        {
            ...
            EmailVerificactionRequired = true
        };
    }
    ...
    public async Task<EmailResponseDto> ResendVerificationEmailAsync(ResendVerificationDto resendDto)
    {
        ...
        user.UserEmail.EmailVerificactionToken = newToken;
